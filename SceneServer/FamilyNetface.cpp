...
void FamilyNetface::on_disconnect()
{
	Log_Warning("friend server disconnect!");
}

void FamilyNetface::trigger()
{
}

void FamilyNetface::handle_msg(const tagMsgHead* pNetMsg)
{
}