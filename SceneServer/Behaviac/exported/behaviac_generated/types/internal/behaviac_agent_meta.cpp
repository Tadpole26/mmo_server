...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(1728747704u);
			...
			// CCmptMonsterAI
			meta = BEHAVIAC_NEW AgentMeta(3219742338u);
			AgentMeta::GetAgentMetas()[2859433608u] = meta;
			meta->RegisterMemberProperty(1333131586u, BEHAVIAC_NEW CMemberProperty< AIState >("m_eCurState", Set_CCmptMonsterAI_m_eCurState, Get_CCmptMonsterAI_m_eCurState));
			meta->RegisterMemberProperty(1230355213u, BEHAVIAC_NEW CMemberProperty< unsigned long long >("m_ullRestExpire", Set_CCmptMonsterAI_m_ullRestExpire, Get_CCmptMonsterAI_m_ullRestExpire));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_CCmptMonsterAI_LogMessage));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta::Register<CCmptMonsterAI>("CCmptMonsterAI");
			AgentMeta::Register<AIState>("AIState");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<CCmptMonsterAI>("CCmptMonsterAI");
			AgentMeta::UnRegister<AIState>("AIState");
