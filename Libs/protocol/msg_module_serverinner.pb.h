...
class Msg_ServerInner_GG_Kich_Notify;
struct Msg_ServerInner_GG_Kich_NotifyDefaultTypeInternal;
extern Msg_ServerInner_GG_Kich_NotifyDefaultTypeInternal _Msg_ServerInner_GG_Kich_Notify_default_instance_;
...
template<> ::ProtoMsg::Msg_ServerInner_GG_Kich_Notify* Arena::CreateMaybeMessage<::ProtoMsg::Msg_ServerInner_GG_Kich_Notify>(Arena*);
...
enum MsgModule_ServerInner_MsgCmd : int {
  ...
  MsgModule_ServerInner_MsgCmd_Msg_ServerInner_GG_Kich_Notify = 6,
...
class MsgModule_ServerInner final :
 ...
 public:
  ...
  static constexpr MsgCmd Msg_ServerInner_GG_Kich_Notify =
    MsgModule_ServerInner_MsgCmd_Msg_ServerInner_GG_Kich_Notify;
...
class Msg_ServerInner_GG_Login_Req final :
 ...
 public:
  ...
  enum : int {
    ...
    kStrProvinceNameFieldNumber = 10,
    kStrDeviceIdFieldNumber = 12,
    kStrChannelFieldNumber = 16,
    kStrCityCodeFieldNumber = 17,
    kLlPlayerIdFieldNumber = 1,
    kUiSdkFieldNumber = 4,
    kUiClientIpFieldNumber = 5,
    kUiReLoginFieldNumber = 6,
    kUiGateIdFieldNumber = 7,
    kUiSeqIdFieldNumber = 8,
    kUiProvinceFieldNumber = 9,
    kUiGmLevelFieldNumber = 11,
    kUiProAreaFieldNumber = 13,
    kBAntiAddFieldNumber = 15,
  };
  // string strAccName = 2;
...
class Msg_ServerInner_GG_Create_Rsp final :
 ...
 public:
  ...
  enum : int {
    kStrPlayerNameFieldNumber = 3,
    kLlPlayerIdFieldNumber = 1,
    kLlRoleIdFieldNumber = 2,
    kLlCreateTimeFieldNumber = 5,
    kUiLevelFieldNumber = 4,
    kIRetCodeFieldNumber = 6,
    kUiSeqIdFieldNumber = 7,
  };
  ...
  // int32 iRetCode = 6;
  void clear_iretcode();
  int32_t iretcode() const;
  void set_iretcode(int32_t value);
  private:
  int32_t _internal_iretcode() const;
  void _internal_set_iretcode(int32_t value);
  public:
...
class Msg_ServerInner_GG_Kich_Notify final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ProtoMsg.Msg_ServerInner_GG_Kich_Notify) */ {
 public:
  inline Msg_ServerInner_GG_Kich_Notify() : Msg_ServerInner_GG_Kich_Notify(nullptr) {}
  ~Msg_ServerInner_GG_Kich_Notify() override;
  explicit PROTOBUF_CONSTEXPR Msg_ServerInner_GG_Kich_Notify(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  Msg_ServerInner_GG_Kich_Notify(const Msg_ServerInner_GG_Kich_Notify& from);
  Msg_ServerInner_GG_Kich_Notify(Msg_ServerInner_GG_Kich_Notify&& from) noexcept
    : Msg_ServerInner_GG_Kich_Notify() {
    *this = ::std::move(from);
  }

  inline Msg_ServerInner_GG_Kich_Notify& operator=(const Msg_ServerInner_GG_Kich_Notify& from) {
    CopyFrom(from);
    return *this;
  }
  inline Msg_ServerInner_GG_Kich_Notify& operator=(Msg_ServerInner_GG_Kich_Notify&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const Msg_ServerInner_GG_Kich_Notify& default_instance() {
    return *internal_default_instance();
  }
  static inline const Msg_ServerInner_GG_Kich_Notify* internal_default_instance() {
    return reinterpret_cast<const Msg_ServerInner_GG_Kich_Notify*>(
               &_Msg_ServerInner_GG_Kich_Notify_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(Msg_ServerInner_GG_Kich_Notify& a, Msg_ServerInner_GG_Kich_Notify& b) {
    a.Swap(&b);
  }
  inline void Swap(Msg_ServerInner_GG_Kich_Notify* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(Msg_ServerInner_GG_Kich_Notify* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  Msg_ServerInner_GG_Kich_Notify* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<Msg_ServerInner_GG_Kich_Notify>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const Msg_ServerInner_GG_Kich_Notify& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const Msg_ServerInner_GG_Kich_Notify& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Msg_ServerInner_GG_Kich_Notify* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ProtoMsg.Msg_ServerInner_GG_Kich_Notify";
  }
  protected:
  explicit Msg_ServerInner_GG_Kich_Notify(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:ProtoMsg.Msg_ServerInner_GG_Kich_Notify)
 private:
  class _Internal;
...
// int64 llPlayerId = 1;
inline void Msg_ServerInner_GG_Login_Req::clear_llplayerid() {
  llplayerid_ = int64_t{0};
}
inline int64_t Msg_ServerInner_GG_Login_Req::_internal_llplayerid() const {
  return llplayerid_;
}
inline int64_t Msg_ServerInner_GG_Login_Req::llplayerid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Login_Req.llPlayerId)
  return _internal_llplayerid();
}
inline void Msg_ServerInner_GG_Login_Req::_internal_set_llplayerid(int64_t value) {
  
  llplayerid_ = value;
}
inline void Msg_ServerInner_GG_Login_Req::set_llplayerid(int64_t value) {
  _internal_set_llplayerid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Login_Req.llPlayerId)
}
...
// uint32 uiClientIp = 5;
inline void Msg_ServerInner_GG_Login_Req::clear_uiclientip() {
  uiclientip_ = 0u;
}
inline uint32_t Msg_ServerInner_GG_Login_Req::_internal_uiclientip() const {
  return uiclientip_;
}
inline uint32_t Msg_ServerInner_GG_Login_Req::uiclientip() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Login_Req.uiClientIp)
  return _internal_uiclientip();
}
inline void Msg_ServerInner_GG_Login_Req::_internal_set_uiclientip(uint32_t value) {
  
  uiclientip_ = value;
}
inline void Msg_ServerInner_GG_Login_Req::set_uiclientip(uint32_t value) {
  _internal_set_uiclientip(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Login_Req.uiClientIp)
}
...
// uint32 uiGateId = 7;
inline void Msg_ServerInner_GG_Login_Req::clear_uigateid() {
  uigateid_ = 0u;
}
inline uint32_t Msg_ServerInner_GG_Login_Req::_internal_uigateid() const {
  return uigateid_;
}
inline uint32_t Msg_ServerInner_GG_Login_Req::uigateid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Login_Req.uiGateId)
  return _internal_uigateid();
}
inline void Msg_ServerInner_GG_Login_Req::_internal_set_uigateid(uint32_t value) {
  
  uigateid_ = value;
}
inline void Msg_ServerInner_GG_Login_Req::set_uigateid(uint32_t value) {
  _internal_set_uigateid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Login_Req.uiGateId)
}

// uint32 uiSeqId = 8;
inline void Msg_ServerInner_GG_Login_Req::clear_uiseqid() {
  uiseqid_ = 0u;
}
inline uint32_t Msg_ServerInner_GG_Login_Req::_internal_uiseqid() const {
  return uiseqid_;
}
inline uint32_t Msg_ServerInner_GG_Login_Req::uiseqid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Login_Req.uiSeqId)
  return _internal_uiseqid();
}
inline void Msg_ServerInner_GG_Login_Req::_internal_set_uiseqid(uint32_t value) {
  
  uiseqid_ = value;
}
inline void Msg_ServerInner_GG_Login_Req::set_uiseqid(uint32_t value) {
  _internal_set_uiseqid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Login_Req.uiSeqId)
}
...
// int32 iFlag = 2;
inline void Msg_ServerInner_GG_Login_Rsp::clear_iflag() {
  iflag_ = 0;
}
inline int32_t Msg_ServerInner_GG_Login_Rsp::_internal_iflag() const {
  return iflag_;
}
inline int32_t Msg_ServerInner_GG_Login_Rsp::iflag() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Login_Rsp.iFlag)
  return _internal_iflag();
}
inline void Msg_ServerInner_GG_Login_Rsp::_internal_set_iflag(int32_t value) {
  
  iflag_ = value;
}
inline void Msg_ServerInner_GG_Login_Rsp::set_iflag(int32_t value) {
  _internal_set_iflag(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Login_Rsp.iFlag)
}

// uint32 uiSeqId = 3;
inline void Msg_ServerInner_GG_Login_Rsp::clear_uiseqid() {
  uiseqid_ = 0u;
}
inline uint32_t Msg_ServerInner_GG_Login_Rsp::_internal_uiseqid() const {
  return uiseqid_;
}
inline uint32_t Msg_ServerInner_GG_Login_Rsp::uiseqid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Login_Rsp.uiSeqId)
  return _internal_uiseqid();
}
inline void Msg_ServerInner_GG_Login_Rsp::_internal_set_uiseqid(uint32_t value) {
  
  uiseqid_ = value;
}
inline void Msg_ServerInner_GG_Login_Rsp::set_uiseqid(uint32_t value) {
  _internal_set_uiseqid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Login_Rsp.uiSeqId)
}
...
// int64 llPlayerId = 1;
inline void Msg_ServerInner_GG_Create_Req::clear_llplayerid() {
  llplayerid_ = int64_t{0};
}
inline int64_t Msg_ServerInner_GG_Create_Req::_internal_llplayerid() const {
  return llplayerid_;
}
inline int64_t Msg_ServerInner_GG_Create_Req::llplayerid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Create_Req.llPlayerId)
  return _internal_llplayerid();
}
inline void Msg_ServerInner_GG_Create_Req::_internal_set_llplayerid(int64_t value) {
  
  llplayerid_ = value;
}
inline void Msg_ServerInner_GG_Create_Req::set_llplayerid(int64_t value) {
  _internal_set_llplayerid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Create_Req.llPlayerId)
}
...
// string strPlayerName = 4;
inline void Msg_ServerInner_GG_Create_Req::clear_strplayername() {
  strplayername_.ClearToEmpty();
}
inline const std::string& Msg_ServerInner_GG_Create_Req::strplayername() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Create_Req.strPlayerName)
  return _internal_strplayername();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Msg_ServerInner_GG_Create_Req::set_strplayername(ArgT0&& arg0, ArgT... args) {
 
 strplayername_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Create_Req.strPlayerName)
}
inline std::string* Msg_ServerInner_GG_Create_Req::mutable_strplayername() {
  std::string* _s = _internal_mutable_strplayername();
  // @@protoc_insertion_point(field_mutable:ProtoMsg.Msg_ServerInner_GG_Create_Req.strPlayerName)
  return _s;
}
inline const std::string& Msg_ServerInner_GG_Create_Req::_internal_strplayername() const {
  return strplayername_.Get();
}
inline void Msg_ServerInner_GG_Create_Req::_internal_set_strplayername(const std::string& value) {
  
  strplayername_.Set(value, GetArenaForAllocation());
}
inline std::string* Msg_ServerInner_GG_Create_Req::_internal_mutable_strplayername() {
  
  return strplayername_.Mutable(GetArenaForAllocation());
}
inline std::string* Msg_ServerInner_GG_Create_Req::release_strplayername() {
  // @@protoc_insertion_point(field_release:ProtoMsg.Msg_ServerInner_GG_Create_Req.strPlayerName)
  return strplayername_.Release();
}
inline void Msg_ServerInner_GG_Create_Req::set_allocated_strplayername(std::string* strplayername) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:ProtoMsg.Msg_ServerInner_GG_Create_Req.strPlayerName)
}
...
// int64 llPlayerId = 1;
inline void Msg_ServerInner_GG_Create_Rsp::clear_llplayerid() {
  llplayerid_ = int64_t{0};
}
inline int64_t Msg_ServerInner_GG_Create_Rsp::_internal_llplayerid() const {
  return llplayerid_;
}
inline int64_t Msg_ServerInner_GG_Create_Rsp::llplayerid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.llPlayerId)
  return _internal_llplayerid();
}
inline void Msg_ServerInner_GG_Create_Rsp::_internal_set_llplayerid(int64_t value) {
  
  llplayerid_ = value;
}
inline void Msg_ServerInner_GG_Create_Rsp::set_llplayerid(int64_t value) {
  _internal_set_llplayerid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.llPlayerId)
}

// int64 llRoleId = 2;
inline void Msg_ServerInner_GG_Create_Rsp::clear_llroleid() {
  llroleid_ = int64_t{0};
}
inline int64_t Msg_ServerInner_GG_Create_Rsp::_internal_llroleid() const {
  return llroleid_;
}
inline int64_t Msg_ServerInner_GG_Create_Rsp::llroleid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.llRoleId)
  return _internal_llroleid();
}
inline void Msg_ServerInner_GG_Create_Rsp::_internal_set_llroleid(int64_t value) {
  
  llroleid_ = value;
}
inline void Msg_ServerInner_GG_Create_Rsp::set_llroleid(int64_t value) {
  _internal_set_llroleid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.llRoleId)
}

// string strPlayerName = 3;
inline void Msg_ServerInner_GG_Create_Rsp::clear_strplayername() {
  strplayername_.ClearToEmpty();
}
inline const std::string& Msg_ServerInner_GG_Create_Rsp::strplayername() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.strPlayerName)
  return _internal_strplayername();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Msg_ServerInner_GG_Create_Rsp::set_strplayername(ArgT0&& arg0, ArgT... args) {
 
 strplayername_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.strPlayerName)
}
inline std::string* Msg_ServerInner_GG_Create_Rsp::mutable_strplayername() {
  std::string* _s = _internal_mutable_strplayername();
  // @@protoc_insertion_point(field_mutable:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.strPlayerName)
  return _s;
}
inline const std::string& Msg_ServerInner_GG_Create_Rsp::_internal_strplayername() const {
  return strplayername_.Get();
}
inline void Msg_ServerInner_GG_Create_Rsp::_internal_set_strplayername(const std::string& value) {
  
  strplayername_.Set(value, GetArenaForAllocation());
}
inline std::string* Msg_ServerInner_GG_Create_Rsp::_internal_mutable_strplayername() {
  
  return strplayername_.Mutable(GetArenaForAllocation());
}
inline std::string* Msg_ServerInner_GG_Create_Rsp::release_strplayername() {
  // @@protoc_insertion_point(field_release:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.strPlayerName)
  return strplayername_.Release();
}
inline void Msg_ServerInner_GG_Create_Rsp::set_allocated_strplayername(std::string* strplayername) {
  if (strplayername != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.strPlayerName)
}

// uint32 uiLevel = 4;
inline void Msg_ServerInner_GG_Create_Rsp::clear_uilevel() {
  uilevel_ = 0u;
}
inline uint32_t Msg_ServerInner_GG_Create_Rsp::_internal_uilevel() const {
  return uilevel_;
}
inline uint32_t Msg_ServerInner_GG_Create_Rsp::uilevel() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.uiLevel)
  return _internal_uilevel();
}
inline void Msg_ServerInner_GG_Create_Rsp::_internal_set_uilevel(uint32_t value) {
  
  uilevel_ = value;
}
inline void Msg_ServerInner_GG_Create_Rsp::set_uilevel(uint32_t value) {
  _internal_set_uilevel(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.uiLevel)
}
...
// int32 iRetCode = 6;
inline void Msg_ServerInner_GG_Create_Rsp::clear_iretcode() {
  iretcode_ = 0;
}
inline int32_t Msg_ServerInner_GG_Create_Rsp::_internal_iretcode() const {
  return iretcode_;
}
inline int32_t Msg_ServerInner_GG_Create_Rsp::iretcode() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.iRetCode)
  return _internal_iretcode();
}
inline void Msg_ServerInner_GG_Create_Rsp::_internal_set_iretcode(int32_t value) {
  
  iretcode_ = value;
}
inline void Msg_ServerInner_GG_Create_Rsp::set_iretcode(int32_t value) {
  _internal_set_iretcode(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.iRetCode)
}

// uint32 uiSeqId = 7;
inline void Msg_ServerInner_GG_Create_Rsp::clear_uiseqid() {
  uiseqid_ = 0u;
}
inline uint32_t Msg_ServerInner_GG_Create_Rsp::_internal_uiseqid() const {
  return uiseqid_;
}
inline uint32_t Msg_ServerInner_GG_Create_Rsp::uiseqid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.uiSeqId)
  return _internal_uiseqid();
}
inline void Msg_ServerInner_GG_Create_Rsp::_internal_set_uiseqid(uint32_t value) {
  
  uiseqid_ = value;
}
inline void Msg_ServerInner_GG_Create_Rsp::set_uiseqid(uint32_t value) {
  _internal_set_uiseqid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Create_Rsp.uiSeqId)
}
...
// int64 llPlayerId = 1;
inline void Msg_ServerInner_GG_Kich_Notify::clear_llplayerid() {
  llplayerid_ = int64_t{0};
}
inline int64_t Msg_ServerInner_GG_Kich_Notify::_internal_llplayerid() const {
  return llplayerid_;
}
inline int64_t Msg_ServerInner_GG_Kich_Notify::llplayerid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Kich_Notify.llPlayerId)
  return _internal_llplayerid();
}
inline void Msg_ServerInner_GG_Kich_Notify::_internal_set_llplayerid(int64_t value) {
  
  llplayerid_ = value;
}
inline void Msg_ServerInner_GG_Kich_Notify::set_llplayerid(int64_t value) {
  _internal_set_llplayerid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Kich_Notify.llPlayerId)
}

// uint32 uiSaveFlag = 2;
inline void Msg_ServerInner_GG_Kich_Notify::clear_uisaveflag() {
  uisaveflag_ = 0u;
}
inline uint32_t Msg_ServerInner_GG_Kich_Notify::_internal_uisaveflag() const {
  return uisaveflag_;
}
inline uint32_t Msg_ServerInner_GG_Kich_Notify::uisaveflag() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Kich_Notify.uiSaveFlag)
  return _internal_uisaveflag();
}
inline void Msg_ServerInner_GG_Kich_Notify::_internal_set_uisaveflag(uint32_t value) {
  
  uisaveflag_ = value;
}
inline void Msg_ServerInner_GG_Kich_Notify::set_uisaveflag(uint32_t value) {
  _internal_set_uisaveflag(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Kich_Notify.uiSaveFlag)
}

// uint32 uiSeqId = 3;
inline void Msg_ServerInner_GG_Kich_Notify::clear_uiseqid() {
  uiseqid_ = 0u;
}
inline uint32_t Msg_ServerInner_GG_Kich_Notify::_internal_uiseqid() const {
  return uiseqid_;
}
inline uint32_t Msg_ServerInner_GG_Kich_Notify::uiseqid() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Kich_Notify.uiSeqId)
  return _internal_uiseqid();
}
inline void Msg_ServerInner_GG_Kich_Notify::_internal_set_uiseqid(uint32_t value) {
  
  uiseqid_ = value;
}
inline void Msg_ServerInner_GG_Kich_Notify::set_uiseqid(uint32_t value) {
  _internal_set_uiseqid(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Kich_Notify.uiSeqId)
}

// .ProtoMsg.ResultCode eCode = 4;
inline void Msg_ServerInner_GG_Kich_Notify::clear_ecode() {
  ecode_ = 0;
}
inline ::ProtoMsg::ResultCode Msg_ServerInner_GG_Kich_Notify::_internal_ecode() const {
  return static_cast< ::ProtoMsg::ResultCode >(ecode_);
}
inline ::ProtoMsg::ResultCode Msg_ServerInner_GG_Kich_Notify::ecode() const {
  // @@protoc_insertion_point(field_get:ProtoMsg.Msg_ServerInner_GG_Kich_Notify.eCode)
  return _internal_ecode();
}
inline void Msg_ServerInner_GG_Kich_Notify::_internal_set_ecode(::ProtoMsg::ResultCode value) {
  
  ecode_ = value;
}
inline void Msg_ServerInner_GG_Kich_Notify::set_ecode(::ProtoMsg::ResultCode value) {
  _internal_set_ecode(value);
  // @@protoc_insertion_point(field_set:ProtoMsg.Msg_ServerInner_GG_Kich_Notify.eCode)
}
