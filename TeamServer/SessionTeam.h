...
public:
	...
	void cancelVote();
public:
	void addToSzQueueTarget();							//�ӳ���������,�ͼ�����ʾ���
	void removeFromSzQueueTarget();
	void addToSzQueueLevelAll();						//�ӳ�������ļ���Ѽ���ƥ�����
...
public:
	SizeQueueTargetPairT szQueueTargetPair;				//team��Ӧtarget����
	SizeQueueLevelListT szQueueLevelList;				//team��Ӧ�ȼ�����,����һ��ƥ������Ӧ���������
private:
	zTeamIdType _teamId = 0;
	uint32 _targetId = 0;								//����Ŀ��(pve��������)
